...
class RealCorpusTests(unittest.TestCase):
    ...
    def test_every_physical_pickup_and_award_group_can_be_suppressed(self):
        ...
        # 352 manifest rows and the three separately-published slice treasures,
        # minus Saw Spear's lot (already covered by the pool-item edit), plus 25
        # continuation rows in shared-acquisition-flag award groups.
        self.assertEqual(len(location_edits), 380)
        self.assertEqual(
    ...
    def test_planned_flags_agree_with_the_runtime_bindings(self):
        ...
        # 351 in-slice fixed pickups plus three published treasures carry lots;
