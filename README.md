...
Generation emits the complete base-game scope and The Old Hunters through
Fishing Hamlet:
...
Nightmare of Mensis, Nightmare Frontier, and all seven DLC regions. There are
635 network locations. The `goal` YAML option follows Bloodborne's three
