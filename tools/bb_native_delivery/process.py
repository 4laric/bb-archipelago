...
ASSERTS: tuple[tuple[str, int, str], ...] = (
    ...
    ("inventory_root_reference", payload.INVENTORY_ROOT_REFERENCE_RVA,
     payload.INVENTORY_ROOT_REFERENCE.hex(" ").upper()),
    ("inventory_offset_reference", payload.INVENTORY_OFFSET_REFERENCE_RVA,
     payload.INVENTORY_OFFSET_REFERENCE.hex(" ").upper()),
